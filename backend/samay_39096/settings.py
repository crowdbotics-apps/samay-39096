"""
Django settings for samay_39096 project.
...
WSGI_APPLICATION = 'samay_39096.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samay_39096 API",
    "DESCRIPTION": "API documentation for samay_39096 App",
    "VERSION": "v1",
}
